        ...
        schemas: {
            RuleSetCreate: {
                ...
                properties: {
                    ...
                    evaluationMode: { type: 'string', enum: ['ALL', 'FIRST_VALID', 'ANY', 'MAJORITY', 'WEIGHTED'], default: 'ALL' },
            ...
            RuleSetResponse: {
                ...
                properties: {
                    ...
                    evaluationMode: { type: 'string', enum: ['ALL', 'FIRST_VALID', 'ANY', 'MAJORITY', 'WEIGHTED'] },
